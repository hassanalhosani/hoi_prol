...
class image_converter:
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/turtlebot/kobuki/realsense/color/image_raw", Image, self.callback)
        self.camera_info_sub = rospy.Subscriber("/turtlebot/kobuki/realsense/color/camera_info", CameraInfo, self.camera_info_callback)
        self.odom_pub = rospy.Subscriber('/turtlebot/odom', Odometry, self.get_odom)
        self.measured_pub = rospy.Publisher("measured_data11", Float32MultiArray)
